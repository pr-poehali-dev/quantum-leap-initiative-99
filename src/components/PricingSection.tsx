...
const pricingTiers = [
  {
    ...
    features: [
      ...
      "Адаптивный дизайн (мобайл)",
      "Контакты, карта, часы работы",
  ...
  },
  {
    ...
    features: [
      ...
      "Личный кабинет / CRM",
      "Интеграция с доставкой или CMS",
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            От небольшой визитки до полноценного сайта с записью и меню — выберите то, что нужно именно вашему заведению
          </p>
        </div>
